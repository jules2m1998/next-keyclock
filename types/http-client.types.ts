...
export interface RequestWithParam<TQuery extends object> extends RequestQueryProps<TQuery>, BaseRequestProps {}

export interface RequestWithBody<TBody extends BodyInit> extends RequestBodyProps<TBody>, BaseRequestProps {}

export interface RequestWithBodyAndParam<TBody extends BodyInit, TQuery extends object>
